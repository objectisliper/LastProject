	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$('#fullpage').fullpage({
				...
				'navigationTooltips': ['Главная', 'Создавай!', 'Общайся!', 'Зарабатывай!', 'Наслаждайся!', 'Контролируй!', 'Будь в курсе!', 'Футер'],
				...
				'afterLoad': function(anchorLink, index){
					if (anchorLink == 'page1'){
						...
						$('head').append('<style>.scroll:before{content: "Создавай!";color: white;}</style>');
					...
					if (anchorLink == 'page2'){
						...
						$('head').append('<style>.scroll:before{content: "Общайся!";color: white;}</style>');
					...
					if (anchorLink == 'page3'){
						...
						$('head').append('<style>.scroll:before{content: "Зарабатывай!";color: white;}</style>');
						$(document).on('click', '.scroll', function(){
					...
					if (anchorLink == 'page4'){
						...
						$('head').append('<style>.scroll:before{content: "Наслаждайся!";color: white;}</style>');
						$(document).on('click', '.scroll', function(){
					...
					if (anchorLink == 'page5'){
						...
						$('head').append('<style>.scroll:before{content: "Контролируй!";color: white;}</style>');
						$(document).on('click', '.scroll', function(){
					...
					if (anchorLink == 'page6'){
						...
						$('head').append('<style>.scroll:before{content: "Будь в курсе!";color: white;}</style>');
						$(document).on('click', '.scroll', function(){
					...
					if (anchorLink == 'page7'){
						...
						$('head').append('<style>.scroll:before{content: "Присоединяйся к нам!";color: white;}</style>');
						$(document).on('click', '.scroll', function(){
...
<body class="rus_ver_site" >
	...
	<div id="test-modal" class="form-reg" style="display: none"><a href="" class="close">&times;</a>
					<form>
						<p style="font-size: 22px; margin-bottom: 15px; font-weight: 300;">Бесплатная регистрация</p>
						<input type="name" class="form-control" id="exampleInputName" aria-describedby="emailHelp" placeholder="Enter name" size="auto">
						<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
						<button type="submit" class="btn btn-grn">Зарегистрироваться</button>
						<div class="registr_link">
						<p style="margin-top: 18px;">Регистрируясь, вы соглашаетесь с условиями</p>
						<a href="">
							<p style="text-decoration: underline;">Лицензионного соглашения и </p>
						</a>
						<a href="">
							<p style="text-decoration: underline;">Положения о защите персональных данных</p>
						</a>
						</div>
					</form>
				</div>
	...
	<div id="header">
			...
			<div class="top clearfix">
				...
				<div class="lang">
				<a class="trigger" href="#"><div id="btn-header-register" class="btn btn-blue" style="border-radius: 5px !important;width: 215px;height: 38px;font-size: 16px !important;line-height: 9px;/*! float: right; */ margin-right: 65px;">Зарегистрироваться</div></a>
				<a href="index-eng.php"><p>ENG</p></a>
	...
	<div class="footer_class" id="footer" style="display: none;">
		<p class="footer-p" style="display: inline-block;position: fixed;left: 20px;margin-top: 14px; color: #547cb1;">2017 © Dafree. Все Права Защищены</p>
		<ul class="list-unlysted rus_ul" style="display: inline-block;margin-top: 14px;">
			<a href="">
				<li class="footer_nav">
					<p>Договор об услугах</p>
				</li>
			</a>
			<a href="">
				<li class="footer_nav">
					<p>Заявление собственности</p>
				</li>
			</a>
			<a href="">
				<li class="footer_nav">
					<p>Анти-Спам политика</p>
				</li>
			</a>
			<a href="">
				<li class="footer_nav">
					<p>Политика возврата денег</p>
				</li>
			</a>
			<a href="">
				<li class="footer_nav">
		...
		<div class="section" id="section0">
			<div class="container">
				...
				<div class="col-7 descktop" style="height: 300px;">
					<div class="text">
					<h1 style="margin-bottom: 70px; font-size: 46px; font-weight: 600;">Dafree
					 - революция в мире блогосферы</h1>
					<h2>Гораздо больше, чем просто площадка для публикации своих мыслей.</h2>
					</div>
				</div> 
				...
				<div class="mobile mobile-text-top" >
					<div id="header">
							<div class="top clearfix">
								<a href="#">
								<div class="logo"><h1>dafree</h1></div>
								<div class="lang"><a href="index-eng.php"><p>ENG</p></a>
					...
					<div class="text">
					<h1 style=" font-weight: bold; margin-bottom: 20px;"><strong>Dafree</strong>
					 - революция в мире блогосферы</h1>
					<h2>Гораздо больше, чем просто площадка для публикации своих мыслей.</h2>
					</div>
				</div> 
						...
						<ul class="nav">
							<div class="col-2">
									<li  class="category_1 nav_category" style="">
										<div id='nav_cat_1' class="category_1_name"><p>Создавай!</p></div>
									</li>
								</div>
							<div class="col-2">
									<li class="category_2 nav_category" style="">
										<div id='nav_cat_2' class="category_2_name"><p>Общайся!</p></div>
									</li>
								</div>
							<div class="col-2">	
									<li class="category_3 nav_category" style="">
										<div id='nav_cat_3' class="category_3_name"><p>Зарабатывай!</p></div>
									</li>
								</div>
							<div class="col-2">	
									<li class="category_4 nav_category" style="">
										<div id='nav_cat_4' class="category_4_name"><p>Наслаждайся!</p></div>
									</li>
								</div>
							<div class="col-2">
									<li class="category_5 nav_category" style="">
										<div id='nav_cat_5' class="category_5_name"><p>Контролируй!</p></div>
									</li>
								</div>
							<div class="col-2">
									<li class="category_6 nav_category" style="">
										<div id='nav_cat_6' class="category_6_name"><p>Будь в курсе!</p></div>
									</li>
								</div>
						</ul>
					</div>
			...
			<div class=" navigation mobile">
					<div class="row">
						<a class="trigger" href="#" style="width: 225px;margin: 0px auto;margin-bottom: 50px;"><div id="btn-header-register" class="btn btn-blue" style="border-radius: 5px !important;width: 215px;height: 38px;font-size: 16px !important;line-height: 9px;/*! float: right; */ margin-right: 65px;">Зарегистрироваться</div></a>
					</div>
					<div class="row">
						<ul class="nav">
							<div class="col-4"><a href="#section1">
									<li class="category_1 nav_category">
										<div class="category_1_name"><p>Создавай!</p></div>
									</li>
								</a></div>
							<div class="col-4"><a href="#section2">
									<li class="category_2 nav_category">
										<div class="category_2_name"><p>Общайся!</p></div>
									</li>
								</a></div>
							<div class="col-4"><a href="#section3">
									<li class="category_3 nav_category">
										<div class="category_3_name"><p>Зарабатывай!</p></div>
									</li>
								</a></div>
						</ul>
					</div>
						...
						<ul class="nav">
							<div class="col-4"><a href="#section4">
									<li class="category_4 nav_category">
										<div class="category_4_name"><p>Наслаждайся!</p></div>
									</li>
								</a></div>
							<div class="col-4"><a href="#section5">
									<li class="category_5 nav_category">
										<div class="category_5_name"><p>Контролируй!</p></div>
									</li>
								</a></div>
							<div class="col-4"><a href="#section6">
									<li class="category_6 nav_category">
										<div class="category_6_name"><p>Будь в курсе!</p></div>
									</li>
								</a></div>
						</ul>
					</div>
		...
		<div class="section moveDown" id="section1">
			<div class="container">
				...
				<div class="row justify-content-end">
						...
						<div class="col-5">
							<div class="create" style="margin-top: -140px !important">
							<h1 style=" margin-bottom: 100px">Создавай!</h1>
							<p style="">Пиши в своем блоге с удовольствием! Многофункциональный редактор, оценка привлекательности текста для читателей и проверка орфографии, мы позаботились обо всем!</p>
							
						</div>
						
					</div>
					<div class="col-6">
						<img class="Girl" src="img/Blocks/Girl.png" style="margin-top: -140px;" alt="">
					</div>
				</div>
				</div>
				<div class="mobile">
		...
		<div class="section moveDown" id="section2">
			<div class="container">
				...
				<div class="row justify-content-end">
						...
						<div class="col-5">
							<div class="create" >
							<h1 style=" margin-bottom: 100px">Общайся!</h1>
							<p style="">Знакомься, комментируй и общайся в чате, веди стримы, обменивайся личными сообщениями и делай многое другое для своего комфортного общения</p>
			...
			<div class="container">
				...
				<div class="row justify-content-end">
						...
						<div class="col-5">
							...
							<h1 style=" margin-bottom: 100px">Зарабатывай!</h1>
							<p style="">Рекламируй себя и других, получай подарки от фанатов, донаты от стримов, бонусы за каждый лайк и много другое!</p>
				...
				<div class="mobile">
					...
					<div class="img-mobile">
							...
							<img class="Girl" src="img/Blocks/Money.png" alt="" style="transform: rotate(-90deg);">
			...
			<div class="container">
				...
				<div class="row justify-content-end">
						...
						<div class="col-5">
							...
							<h1 style="">Наслаждайся!</h1>
							<div style="" class="list-stars">
							<ul class="list-unstyled" style="padding: 0px">
								<li>
									<div class="stars"><img src="img/Icons/star_2.svg"></div>
									<p>Удобная и информативная статистика блога</p>
								</li>
								<li>
									<div class="stars"><img src="img/Icons/star_2.svg"></div>
									<p>Собственный сайт с индивидуальным дизайном</p>
								</li>
								<li>
									<div class="stars"><img src="img/Icons/star_2.svg"></div>
									<p>Возможность ведения видео-трансляции и обратная связь с пользователями</p>
								</li>
								<li>
									<div class="stars"><img src="img/Icons/star_2.svg"></div>
									<p>Интеграция с популярными сервисами (facebook, vk, twitter и др)</p>
								</li>
								<li>
									<div class="stars"><img src="img/Icons/star_2.svg"></div>
									<p>Набор инструментов для SEO - продвижения, в
строенный в твой блог</p>
								</li>
							</ul>
							</div>
			...
			<div class="mobile">
				<div class="row">
								...
								<div class="create" >
								<h1 style="">Наслаждайся!</h1>
								<p style="">Удобная и информативная статистика блога, собственный сайт с индивидуальным дизайном, возможность ведения видео-трансляции и обратная связь с пользователями, интеграция с популярными сервисами (facebook, vk, twitter и др), набор инструментов для SEO - продвижения, в
								строенный в твой блог.</p>
		...
		<div class="section moveDown" id="section5">
			<div class="container">
				...
				<div class="row justify-content-end">
						...
						<div class="col-5" >
							<div class="create" style="margin-top: -70px !important;">
							<h1 style=" margin-bottom: 100px;">Контролируй!</h1>
							<p style="">Теперь заниматься рекламой в своем блоге – одно удовольствие! Размещай рекламу в пару кликов, выбирай с кем работать, устанавливай желаемую цену. Управляй этим играючи через удобный и понятный интерфейс личного кабинета.</p>
		...
		<div class="section moveDown" id="section6">
			<div class="container">
				...
				<div class="row justify-content-end">
						...
						<div class="col-5">
							<div class="create" style="margin-top: -70px !important;">
							<h1 style="margin-bottom: 100px;">Будь в курсе</h1>
							<p style="">Выбирай любимые каналы и категории, получая самые свежие новости обо всем, что интересно именно тебе!</p>
		...
		<div class="section moveDown" id="section7">
			...
			<div class="descktop">
				...
				<div class="col-7" style="height: 300px;">
					...
					<h1 style=" ">Присоединяйся</h1> <h1 style=" ">к нам</h1>
			...
			<div class="row" style="/*! margin-top: 36vh; */position: absolute;bottom: 0px;/*! top: 0px; *//*! left: 0px; *//*! right: 0px; */width: 100%;height: 80px;">
				...
				<div class="col-12">
					<ul class="list-unstyled" style="width: 760px;margin: 0px auto;">
						<a href="">
							<li class="info_src">
